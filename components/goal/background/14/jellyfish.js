...
var squiggles = require('./squiggles')

module.exports = class Jellyfish extends Component {
  load (element) {
    var paths = element.querySelectorAll('.js-path')
  ...
  createElement () {
    return html`
      <div class="Background14-jellyfish">
