...
module.exports = class Background15 extends Component {
  ...
  load (element) {
    ...
    var giraffeNeck = element.querySelector('.js-giraffeNeck')
    ...
    return html`
      <div class="Background15 ${opts.size === 'small' ? 'Background15--small' : ''}" id="background-15">
        <svg class="u-hiddenVisually">
          <symbol viewBox="0 0 40 21" id="background15-bee-symbol">
          ...
          <svg viewBox="0 0 54 14" id="background15-bird-symbol">
        ...
        <div class="Background15-savannahSky">
          <div>
            <svg class="Background15-bee" width="40" height="21"><use xlink:href="#background15-bee-symbol" /></svg>
            <svg class="Background15-bee" width="40" height="21"><use xlink:href="#background15-bee-symbol" /></svg>
          </div>
          <div>
          ...
          <div>
            <svg viewBox="0 0 50 50" width="50" height="50" class="Background15-savannahCloud Background15-savannahCloud--sm"><circle r="25" cx="25" cy="25" fill="currentColor" /></svg>
            <svg viewBox="0 0 50 50" width="50" height="50" class="Background15-savannahCloud Background15-savannahCloud--md"><circle r="25" cx="25" cy="25" fill="currentColor" /></svg>
            <svg viewBox="0 0 141 97" width="141" height="97" class="Background15-savannahCloud Background15-savannahCloud--xl Background15-savannahCloud--dim">
            ...
            <svg viewBox="0 0 50 50" width="50" height="50" class="Background15-savannahCloud Background15-savannahCloud--md"><circle r="25" cx="25" cy="25" fill="currentColor" /></svg>
            <svg viewBox="0 0 50 50" width="50" height="50" class="Background15-savannahCloud Background15-savannahCloud--lg Background15-savannahCloud--light"><circle r="25" cx="25" cy="25" fill="currentColor" /></svg>
            <svg viewBox="0 0 50 50" width="50" height="50" class="Background15-savannahCloud Background15-savannahCloud--sm Background15-savannahCloud--dark"><circle r="25" cx="25" cy="25" fill="currentColor" /></svg>
          </div>
        </div>
        <svg class="Background15-savannah Background15-savannah--left" viewBox="0 0 236 83" width="236" height="75">
          <g fill="none" fill-rule="evenodd">
            <path class="Background15-savannahThing" d="M208.03 66.944v18.148h8.17V66.75c10.42-2.047 18.25-10.925 18.9-22.75h.043c0-.27-.003-.542-.01-.818.007-.26.01-.524.01-.788h-.04c-.725-15.08-11.315-38.402-24.02-38.402-12.704 0-22.866 23.323-23.562 38.402h-.03c0 .258.01.515.01.77 0 .282-.01.56-.01.836h.05c.71 12.252 9.45 21.34 20.5 22.944z" fill="#105702"/>
            <path class="Background15-savannahThing" d="M166.305 66.468v16.595h8.58V66.416l12.18-.075c7.885 0 14.28-6.46 14.28-14.43 0-3.83-1.485-7.3-3.895-9.89 4.005-2.33 6.715-6.69 6.715-11.7 0-7.45-5.97-13.49-13.335-13.49-.29 0-.57.03-.855.05C189.27 7.44 181.51 0 172.005 0c-9.965 0-18.04 8.17-18.04 18.252 0 2.853.67 5.545 1.825 7.953-9.03 2.023-15.79 10.158-15.79 19.9 0 11.267 9.03 20.398 20.16 20.398.244 0 2.75-.014 6.145-.035z" fill="#FFF"/>
            <g fill="#FFF">
              <g class="Background15-savannahThing">
        ...
        <svg class="Background15-savannah Background15-savannah--right" viewBox="0 0 374 193" width="374" height="193">
          <g fill="#FFF" fill-rule="evenodd">
            <g class="Background15-savannahThing">
