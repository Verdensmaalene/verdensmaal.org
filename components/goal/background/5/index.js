...
module.exports = class Background5 extends Component {
  update () {
    return false
  }
  ...
  createElement (opts = {}) {
    return html`
      <div class="Background5 ${opts.size === 'small' ? 'Background5--small' : ''}" id="background-5">
        <svg class="u-hiddenVisually">
          <defs>
            <g id="background5-patriarch" viewBox="0 0 29 137">
            ...
            <g id="background5-woman" viewBox="0 0 61 137">
        ...
        <div class="Background5-people">
          <svg class="Background5-person" viewBox="0 0 61 137" width="61" height="137">
            <use class="Background5-figure" x="32.2" xlink:href="#background5-patriarch" />
            <g class="Background5-grower">
              <use xlink:href="#background5-woman" />
            </g>
          </svg>
          <svg class="Background5-person" viewBox="0 0 61 137" width="61" height="137">
            <use class="Background5-figure" x="32.2" xlink:href="#background5-patriarch" />
            <g class="Background5-grower"><use xlink:href="#background5-woman" /></g>
          </svg>
          <svg class="Background5-person" viewBox="0 0 61 137" width="61" height="137">
            <use class="Background5-figure" x="32.2" y="0.5" xlink:href="#background5-patriarch" />
            <g class="Background5-grower">
              <use xlink:href="#background5-woman" y="0.5" />
            </g>
          </svg>
          <svg class="Background5-person" viewBox="0 0 61 137" width="61" height="137">
            <use class="Background5-figure" x="32.2" xlink:href="#background5-patriarch" />
