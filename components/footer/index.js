        ...
        <div class="Footer">
          ...
          <form class="Footer-section Footer-section--newsletter" action="/api/subscribe" onsubmit=${onsubmit}>
            ...
            <div class="Footer-fields">
              <label class="u-hiddenVisually" for="${this.state.id}-name">${text`Your name`}</label>
              <input class="Footer-field u-spaceR1" type="text" name="name" id="${this.state.id}-name" placeholder="${text`Your name`}" required>
              <label class="u-hiddenVisually" for="${this.state.id}-email">${text`Your email`}</label>
              <input class="Footer-field" type="email" name="email" id="${this.state.id}-email" placeholder="${text`Your email`}" required>
