    ...
    return html`
      <div class="Events-Filter">
        <div class="Events-Filter-Actions">
          ...
          ${button({ id: 'filter-open', primary: true, text: text`${this.local.open ? 'Gem' : 'Filtrer' + (this.local.selected.tags.length ? ` (${this.local.selected.tags.length})` : '')}` })}
        </div>

        <div style="${ this.local.open ? '' : 'visibility:hidden; pointer-events:none;' }" class="Events-Filter-Modal-Outer">
